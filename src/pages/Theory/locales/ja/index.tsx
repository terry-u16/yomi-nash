    ...
    <Box p={6} borderRadius="sm" bg="bg.subtle" boxShadow="sm">
      <Stack gap={6}>
        <Alert.Root status="info">
          ...
          <Alert.Description>
            <Text>
              操作方法や基本的な使い方はヘルプページを参照してください。理論ページは、アプリで計算している数学的な理論背景を深掘りしたい方向けのページです。
            </Text>
          </Alert.Description>
        </Alert.Root>
        <Stack gap={3}>
          ...
          <Text>
            ヘルプページでは操作手順や結果の読み方を中心に説明しています。理論ページでは、入力された利得行列からなぜ「おすすめの選択割合」が得られるのかを、数理モデルとして説明します。
          </Text>
        </Stack>
        <Separator />
        <Stack gap={4}>
